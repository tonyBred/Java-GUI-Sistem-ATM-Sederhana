 ...
 * @author ASUS
 */
public class TransferNominalFrame extends javax.swing.JFrame{
    private ATM atm;
     ...
     */
     public TransferNominalFrame(){
        initComponents();
     }
     
    public TransferNominalFrame(ATM atm, int accountNumber, int accountNumberTransfer) {
        initComponents();
        this.atm = atm;
        this.accountNumber = accountNumber;
        this.bankDatabase = atm.getBankDatabase();
        this.accountNumberTransfer = accountNumberTransfer;
    }
    ...
    private void initComponents() {
        ...
        PanelNumerikLayout.setHorizontalGroup(
            ...
            .addGroup(PanelNumerikLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(PanelNumerikLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jLabel2.setText("Silahkan Masukan Nominal");
    ...
    private void transfer(int amount) throws IOException{
        ...
        if (amount <= availableBalance) {
            ...
            // update the account involved to reflect the transfer
            bankDatabase.debit(accountNumber, amount);
            bankDatabase.credit(accountNumberTransfer, amount);


            // instruct user to take cash
            JOptionPane.showMessageDialog(this, "Transfer Berhasil Berhasil");
                 dispose();
    ...
    private void confirmation(int amount) throws IOException{
        int jawab = JOptionPane.showOptionDialog(this, 
                    "Yakin ingin Transafer Rp. ?" + amount + " Ke Account Number : " + accountNumberTransfer, 
                    "Konfirmasi", 
    ...
    private void btnSelesaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelesaiActionPerformed
        try {
            // TODO add your handling code here:
            confirmation(Integer.parseInt(txtAN.getText()));
        } catch (IOException ex) {
            Logger.getLogger(TransferNominalFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransferNominalFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransferNominalFrame().setVisible(true);
            }
        });
    }
